...
## Known issues
- The list of dynamic materials is not automatically refreshed when the stage change (create/load new scene, delete material in the stage, etc.), you'll need to manually update the list by clicking the corresponding button in the extension window.
